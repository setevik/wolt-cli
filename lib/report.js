...
export function processData(orders) {
    try {
        ...
        validOrders.forEach(order => {
            ...
            // Track venue stats for top venues
            ...
            // Track biggest order
            if (totalAmount > biggestOrder.amount) {
                biggestOrder = {
                    amount: totalAmount,
                    venue: venueName,
            ...
            // Track late night orders (after 10pm)
        ...
        const avgOrderValue = totalOrderCount > 0 ? (ytdTotal + lastYearTotal) / totalOrderCount : 0;
        ...
        return { monthly: [], monthsKeys: [], ytdTotal: 0, lastYearTotal: 0, last6MonthsTotal: 0, ytdDistance: 0, lastYearDistance: 0, venueTypes: {}, uniqueVenueTypes: [], stackedTypes: [], totalDeliveryFees: 0, totalServiceFees: 0, dailyActivity: {}, topVenues: [], avgOrderValue: 0, ytdOrderCount: 0, lastYearOrderCount: 0, totalOrderCount: 0, topItems: [], costBreakdown: { items: 0, delivery: 0, service: 0 }, favoriteDay: { name: '', orderCount: 0, totalSpent: 0 }, dayOfWeekBreakdown: [], biggestOrder: { amount: 0, venue: '', date: '' }, lateNightOrders: 0, totalItemsCount: 0 };
    }
}
